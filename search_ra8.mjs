/** search_ra8.mjs : RA8「高所作業車 走行中の段差/穴で転倒」の事故イラスト収集。
 *  3要素必須: (1)機械=高所作業車(自走式/トラック式等) (2)事象=走行中に段差/穴/くぼみ/縁石/溝でタイヤが落ち機体ごと転倒が起きている (3)人(搭乗者)が投げ出され/被災・されかけ。
...
const OUT="C:/Users/kanet/20260522/safe1/refs2/RA8/_cand"; fs.mkdirSync(OUT,{recursive:true});
...
const QUERIES=[
  // clipart寄り(イラスト)
  ["高所作業車 走行中 段差 転倒 災害 イラスト",true],
  ["高所作業車 走行 穴 くぼみ 落輪 転倒 事故 イラスト",true],
  ["高所作業車 移動中 路面 段差 横転 KYT イラスト",true],
  ["自走式高所作業車 走行 縁石 溝 タイヤ 転倒 災害事例 イラスト",true],
  ["高所作業車 走行 不整地 転倒 搭乗者 投げ出され 安全ポスター イラスト",true],
  ["高所作業車 ブーム上げたまま 走行 段差 転倒 注意喚起 イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["建災防 高所作業車 走行 段差 転倒 災害事例",false],
  ["職場のあんぜんサイト 高所作業車 走行 転倒 災害事例",false],
  ["陸災防 高所作業車 移動 段差 横転 災害事例",false],
  ["MEWP driving over pothole hole tip over accident illustration worker",false],
  ["scissor lift traveling bump curb overturn accident worker thrown illustration",false],
  ["aerial work platform drive uneven ground depression tipping accident illustration",false],
];
