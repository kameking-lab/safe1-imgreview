/** search_ra5.mjs : RA5「高所作業車 急動作/操作ミスで搭乗者が振られ墜落」の事故イラスト収集。
 *  3要素必須: (1)機械=高所作業車(ブーム/シザース等) (2)急動作・操作ミスで作業床が振られ墜落が起きている (3)人(搭乗者)が振られ墜落・被災。
...
const QUERIES=[
  // clipart寄り(イラスト)
  ["高所作業車 急操作 操作ミス 作業床 振られ 墜落 災害 イラスト",true],
  ["高所作業車 ブーム 急動作 反動 振られて 墜落 注意喚起 イラスト",true],
  ["高所作業車 レバー 急操作 作業床 揺れ 投げ出され 墜落 KYT イラスト",true],
  ["高所作業車 バケット 急上昇 急停止 反動 墜落 災害事例 イラスト",true],
  ["高所作業車 操作ミス 作業床 衝撃 振り落とされ 安全帯 墜落 イラスト",true],
  ["高所作業車 ブーム 旋回 急旋回 作業床 振られ 転落 災害 イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["建荷協 高所作業車 急操作 作業床 振られ 墜落 災害事例",false],
  ["職場のあんぜんサイト 高所作業車 操作ミス 急動作 墜落 災害事例",false],
  ["陸災防 高所作業車 急操作 反動 作業床 振られ 墜落 災害事例",false],
  ["aerial lift sudden movement operator thrown from basket fall accident illustration",false],
  ["boom lift jerk lurch worker ejected catapulted from platform fall accident",false],
  ["MEWP sudden jolt operator catapult fall from basket accident safety illustration",false],
];
