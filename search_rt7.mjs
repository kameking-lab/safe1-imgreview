/** search_rt7.mjs : RT7「昇降板の誤操作で被災」の事故イラスト収集。
...
const QUERIES=[
  // clipart寄り(イラスト): 昇降板の誤操作・操作ミス・不意作動で被災
  ["テールゲートリフター 誤操作 災害 イラスト",true],
  ["パワーゲート 操作ミス 事故 作業者 災害 イラスト",true],
  ["テールゲートリフター 不意作動 はさまれ 被災 イラスト",true],
  ["昇降板 誤操作 起動 巻き込まれ 災害事例 イラスト",true],
  ["テールゲートリフター スイッチ 誤操作 転落 災害 イラスト",true],
  ["トラック 昇降装置 操作ミス リモコン 被災 イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["テールゲートリフター 誤操作 災害事例",false],
  ["職場のあんぜんサイト テールゲートリフター 誤操作 はさまれ",false],
  ["テールゲートリフター 死亡災害 操作ミス 不意作動",false],
  ["tail lift gate operation error worker injury accident illustration",false],
];
