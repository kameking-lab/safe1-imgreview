# (A)イラスト収集
- [ ] A1 収集計画 collect_plan.md 作成
- [ ] A2 TGL事故イラスト収集 バッチ1（重複排除・連番保存・index更新）
- [ ] A3 TGL事故イラスト収集 バッチ2
- [ ] A4 高所事故イラスト収集 バッチ1
- [ ] A5 高所事故イラスト収集 バッチ2
- [ ] A6 全体重複再排除・通し番号確定・img_index.csv確定（計50〜100）
# (B)事故情報1000件×2
- [ ] B1 JNIOSH CSV群DL・パース（data/jniosh/・既存流用）
- [ ] B2 TGL抽出・重複排除・カテゴリ付与（目標1000）
