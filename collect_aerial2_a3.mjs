/** collect_aerial2_a3.mjs : A3「挟まれ・巻き込まれ」高所作業車の事故/危険イメージ画像 収集。
 ...
 *  雛形 safe1/search_ra1.mjs / collect_aerial2_a2.mjs 準拠（a.iusc解析・Referer fetch・拡張子中身判定）。*/
...
// --- A3 挟まれ・巻き込まれ クエリ（[query, clipart寄りか, 種別ラベル]）---
const QUERIES = [
  ["高所作業車 挟まれ 災害 イラスト", true,  "教育イラスト"],
  ["高所作業車 挟まれ 天井 鉄骨 事故 イラスト", true, "教育イラスト"],
  ["高所作業車 バケット 挟まれ 上昇 災害 イラスト", true, "教育イラスト"],
  ["高所作業車 挟まれ 上部構造物 頭部 災害 イラスト", true, "教育イラスト"],
  ["高所作業車 巻き込まれ ヒヤリハット KYT イラスト", true, "KYT教材"],
  ["高所作業車 挟まれ 操作レバー 誤操作 危険 イラスト", true, "ヒヤリハット挿絵"],
  ["高所作業車 挟まれ 注意喚起 ポスター", true, "注意喚起ポスター"],
  ["高所作業車 バケット 天井 挟まれ 注意 イラスト", true, "教育イラスト"],
  ["高所作業車 はさまれ 上昇 障害物 災害 イラスト", true, "教育イラスト"],
  ["高所作業車 挟圧 死亡 防止 イラスト", true, "教育イラスト"],
  ["高所作業車 挟まれ 死亡災害 事例 厚生労働省", false, "実事例図/写真"],
  ["職場のあんぜんサイト 高所作業車 挟まれ 災害事例", false, "実事例図/写真"],
  ["高所作業車 挟まれ 災害事例 建災防", false, "実事例図/写真"],
  ["高所作業車 挟まれ 巻き込まれ 災害事例 図", false, "実事例図/写真"],
  ["高所作業車 挟まれ 上部 構造物 死亡災害 事例", false, "実事例図/写真"],
  ["aerial lift crushing caught between accident illustration", true, "教育イラスト"],
  ["boom lift crush hazard overhead structure illustration", true, "教育イラスト"],
  ["aerial work platform sustained involuntary operation crush accident", false, "実事例図/写真"],
  ["scissor lift crushed between ceiling caught accident illustration", true, "教育イラスト"],
  ["MEWP crushing trapping hazard poster safety", true, "注意喚起ポスター"],
];
...
try {
  for (const [q, clip, kind] of QUERIES) {
    ...
    if (zeroStreak >= 8) { console.log("=== 8クエリ連続 新規ゼロ → A3終了 ==="); break; }
...
console.log(`\nA3 DONE: saved=${savedTotal}  totalImgNum=${n}  queriesRun=${newQueriesDone.length}`);
