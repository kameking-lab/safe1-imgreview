/** search_ra7.mjs : RA7「高所作業車 アウトリガー未設置/不良で転倒」の事故イラスト収集。
 *  3要素必須: (1)機械=高所作業車(ブーム/トラック式等) (2)事象=アウトリガー(張出し)未設置/不良が原因で機体ごと転倒が起きている (3)人(搭乗者)が投げ出され/被災・されかけ。
...
const OUT="C:/Users/kanet/20260522/safe1/refs2/RA7/_cand"; fs.mkdirSync(OUT,{recursive:true});
...
const QUERIES=[
  // clipart寄り(イラスト)
  ["高所作業車 アウトリガー 未設置 転倒 災害 イラスト",true],
  ["高所作業車 アウトリガー 張り出し不足 転倒 事故 イラスト",true],
  ["高所作業車 アウトリガー 沈下 めり込み 転倒 災害事例 イラスト",true],
  ["トラック式高所作業車 アウトリガー 不良 横転 KYT イラスト",true],
  ["高所作業車 ジャッキ 敷板なし 地盤沈下 転倒 注意喚起 イラスト",true],
  ["高所作業車 転倒 搭乗者 投げ出され 安全ポスター イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["建災防 高所作業車 アウトリガー 転倒 災害事例",false],
  ["職場のあんぜんサイト 高所作業車 アウトリガー 転倒 災害事例",false],
  ["陸災防 高所作業車 アウトリガー 張出し 転倒 災害事例",false],
  ["aerial lift outrigger not deployed tip over accident illustration",false],
  ["bucket truck outrigger failure overturn tipping accident worker safety",false],
  ["MEWP truck mounted outrigger ground sink overturn accident illustration",false],
];
