/** search_rt2.mjs : RT2候補(昇降板と荷台/車体の間に頭部・上半身はさまれ)をBing画像検索で集め、
 *  全メタを保存 + node fetchでDL(CORS回避)。
...
const QUERIES=[
  "テールゲートリフター はさまれ 災害事例 イラスト",
  "テールゲートリフター 昇降板 荷台 挟まれ 注意 イラスト",
  "テールゲートリフター 頭 挟まれ 災害 図",
  "陸災防 テールゲートリフター はさまれ 災害 イラスト",
  "トラック 昇降板 挟まれ 死亡 KY イラスト",
  "テールゲートリフター 巻き込まれ はさまれ 事例 図",
  "tail lift platform crushed trapped accident worker illustration",
  "truck tail lift pinned between platform body accident illustration",
];
