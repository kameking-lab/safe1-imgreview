/** search_ra9.mjs : RA9「高所作業車 積載超過/無理姿勢で転倒」の事故イラスト収集。
 *  3要素必須: (1)機械=高所作業車(ブーム式/シザース式/トラック搭載等) (2)事象=積載超過(定格超過)や搭乗者の無理な姿勢(手すり越し身を乗り出す/重量物を持つ)でバランスを崩し機体ごと転倒が起きている (3)人(搭乗者)が投げ出され/被災・されかけ。
...
const OUT="C:/Users/kanet/20260522/safe1/refs2/RA9/_cand"; fs.mkdirSync(OUT,{recursive:true});
...
const QUERIES=[
  // clipart寄り(イラスト)
  ["高所作業車 積載超過 定格荷重超過 転倒 災害 イラスト",true],
  ["高所作業車 作業床 重量物 載せすぎ 転倒 事故 イラスト",true],
  ["高所作業車 搭乗者 無理な姿勢 身を乗り出し 転倒 KYT イラスト",true],
  ["高所作業車 ブーム 過積載 バランス 崩し 横転 災害事例 イラスト",true],
  ["高所作業車 手すり越し 乗り出し 重い物 転倒 安全ポスター イラスト",true],
  ["高所作業車 定格 超え 搭乗者 投げ出され 墜落 注意喚起 イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["建災防 高所作業車 積載超過 転倒 災害事例",false],
  ["職場のあんぜんサイト 高所作業車 過積載 無理な姿勢 転倒 災害事例",false],
  ["陸災防 高所作業車 定格荷重超過 横転 災害事例",false],
  ["MEWP boom lift overload exceed capacity tip over accident illustration worker",false],
  ["aerial lift basket overloaded heavy load overturn worker thrown illustration",false],
  ["scissor lift overreaching leaning out overload tipping accident illustration worker",false],
];
