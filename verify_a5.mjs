...
const urls=[
  "https://e-sogo.co.jp/images/news/02_skymaster_safety_guides.jpg",
];
  ...
  for(const u of urls){
    try{
      ...
      if(r.ok() && buf && /image\//.test(ct)){
        fs.writeFileSync("refs/cand_A5/z04_full.jpg",buf); console.log("  wrote refs/cand_A5/z04_full.jpg");
      }
