/** search_ra1.mjs : RA1「高所作業車 不整地/傾斜で機体ごと転倒・搭乗者投げ出され」の事故イラスト収集。
 *  3要素必須: (1)機械=高所作業車(ブーム/シザース等) (2)機体ごと転倒/横転が起きている (3)搭乗者が投げ出され/墜落・被災。
...
const OUT="C:/Users/kanet/20260522/safe1/refs2/RA1/_cand"; fs.mkdirSync(OUT,{recursive:true});
...
const QUERIES=[
  // clipart寄り(イラスト)
  ["高所作業車 転倒 不整地 機体 災害 イラスト",true],
  ["高所作業車 横転 搭乗者 投げ出され 墜落 災害 イラスト",true],
  ["高所作業車 軟弱地盤 傾き 転倒 作業者 被災 イラスト",true],
  ["ブーム式 高所作業車 横転 転倒 災害事例 KYT イラスト",true],
  ["高所作業車 傾斜地 転倒 搭乗者 放り出される 注意喚起 イラスト",true],
  ["高所作業車 転倒 死亡災害 事例 イラスト",true],
  // photo含む(災害事例DBの図はphoto判定されがち)
  ["陸災防 建災防 高所作業車 転倒 災害事例 イラスト",false],
  ["職場のあんぜんサイト 高所作業車 転倒 災害事例",false],
  ["高所作業車 転倒 死亡災害 厚生労働省 事例",false],
  ["aerial work platform boom lift tip over uneven ground worker thrown accident illustration",false],
];
